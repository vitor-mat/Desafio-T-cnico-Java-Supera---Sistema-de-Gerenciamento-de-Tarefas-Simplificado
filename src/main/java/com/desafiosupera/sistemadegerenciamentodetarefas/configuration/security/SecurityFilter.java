package com.desafiosupera.sistemadegerenciamentodetarefas.configuration.security;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if(token != null) {
            ...
            var authenticatin = new UsernamePasswordAuthenticationToken(user, null, user.getAuthorities());
